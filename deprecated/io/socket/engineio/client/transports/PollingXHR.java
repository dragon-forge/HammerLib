...
import com.zeitheron.hammercore.lib.okhttp3.MediaType;
...
public class PollingXHR extends Polling
{
	...
	public static class Request extends Emitter
	{
		...
		public void create()
		{
			...
			if(LOGGABLE_FINE)
			{
				logger.fine(String.format("sending xhr with url %s | data %s", this.uri, this.data instanceof byte[] ? Arrays.toString((byte[]) this.data) : this.data));
			}
			
			com.zeitheron.hammercore.lib.okhttp3.Request.Builder requestBuilder = new com.zeitheron.hammercore.lib.okhttp3.Request.Builder();
			...
			com.zeitheron.hammercore.lib.okhttp3.Request request = requestBuilder.url(HttpUrl.parse(self.uri)).method(self.method, body).build();
