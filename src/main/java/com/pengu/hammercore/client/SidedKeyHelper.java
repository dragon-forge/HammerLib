...
public class SidedKeyHelper
{
	...
	public static final int KEY_NUMPADEQUALS = 0x8D; /* = on numeric keypad (NEC
	                                                  * PC98) */
	...
	public static final int KEY_NUMPADENTER = 0x9C; /* Enter on numeric
	                                                 * keypad */
	public static final int KEY_RCONTROL = 0x9D;
	public static final int KEY_SECTION = 0xA7; /* Section symbol (Mac) */
	public static final int KEY_NUMPADCOMMA = 0xB3; /* , on numeric keypad (NEC
	                                                 * PC98) */
	...
	public static boolean cIsKeyPressed(int key)
	{
		return HammerCore.nativeProxy.npCallb(0x001, key);
	}
}