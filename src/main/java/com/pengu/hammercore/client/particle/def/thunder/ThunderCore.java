...
public class ThunderCore
{
	...
	public ThunderCore(World world, final ThVector3 jammervec, final ThVector3 targetvec, final long seed)
	{
	...
	public ThunderCore(World world, Entity detonator, Entity target, final long seed)
	{
		this(world, new ThVector3(detonator), new ThVector3(target), seed);
	}
	
	public ThunderCore(World world, Entity detonator, Entity target, final long seed, final int speed)
	{
		this(world, new ThVector3(detonator), new ThVector3(target.posX, target.posY + target.getEyeHeight() - 0.699999988079071, target.posZ), seed);
		increment = speed;
		multiplier = 0.4f;
	}
	
	public ThunderCore(World world, final double x1, final double y1, final double z1, final double x, final double y, final double z, final long seed, final int duration, final float multi, final int speed)
	{
		this(world, new ThVector3(x1, y1, z1), new ThVector3(x, y, z), seed);
