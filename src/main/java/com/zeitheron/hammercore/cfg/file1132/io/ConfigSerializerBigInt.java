...
public class ConfigSerializerBigInt extends ConfigEntrySerializer<ConfigEntryBigInt>
{
	...
	@Override
	public void write(Configuration config, BufferedWriter writer, ConfigEntryBigInt entry, int indents) throws IOException
	{
	...
	@Override
	public ConfigEntryBigInt read(Configuration config, ReaderHelper reader, int indents) throws IOException
	{
