...
import com.zeitheron.hammercore.lib.io.socket.emitter.Emitter;
import com.zeitheron.hammercore.lib.io.socket.engineio.client.transports.Polling;
import com.zeitheron.hammercore.lib.io.socket.engineio.client.transports.PollingXHR;
import com.zeitheron.hammercore.lib.io.socket.engineio.client.transports.WebSocket;
 ...
 *
 * @see <a href=
 *      "https://github.com/LearnBoost/engine.io-client">https://github.com/LearnBoost/engine.io-client</a>
 */
public class Socket extends Emitter
{
	...
	private static com.zeitheron.hammercore.lib.okhttp3.WebSocket.Factory defaultWebSocketFactory;
	private static com.zeitheron.hammercore.lib.okhttp3.Call.Factory defaultCallFactory;
	...
	private com.zeitheron.hammercore.lib.okhttp3.WebSocket.Factory webSocketFactory;
	private com.zeitheron.hammercore.lib.okhttp3.Call.Factory callFactory;
	...
	public Socket(Options opts)
	{
		...
		this.port = opts.port;
		this.query = opts.query != null ? ParseQS.decode(opts.query) : new HashMap<String, String>();
		...
		this.transports = new ArrayList<String>(Arrays.asList(opts.transports != null ? opts.transports : new String[] { Polling.NAME, WebSocket.NAME }));
	...
	public static void setDefaultOkHttpWebSocketFactory(com.zeitheron.hammercore.lib.okhttp3.WebSocket.Factory factory)
	{
		defaultWebSocketFactory = factory;
	}
	
	public static void setDefaultOkHttpCallFactory(com.zeitheron.hammercore.lib.okhttp3.Call.Factory factory)
	{
	 ...
	 * @param msg
	 * @param fn
	 *            callback to be called on drain
	 */
			...
			public void run()
			{
				if(Socket.this.readyState == ReadyState.OPENING || Socket.this.readyState == ReadyState.OPEN)
				{
					...
					final Runnable waitForUpgrade = new Runnable()
					{
						...
						public void run()
						{
							// wait for updade to finish since we can't send
