...
import com.zeitheron.hammercore.lib.io.socket.backo.Backoff;
import com.zeitheron.hammercore.lib.io.socket.emitter.Emitter;
import com.zeitheron.hammercore.lib.io.socket.parser.IOParser;
import com.zeitheron.hammercore.lib.io.socket.parser.Packet;
import com.zeitheron.hammercore.lib.io.socket.parser.Parser;
...
public class Manager extends Emitter {
    ...
    /*package*/ com.zeitheron.hammercore.lib.io.socket.engineio.client.Socket engine;
    ...
    public Manager open(final OpenCallback fn) {
        EventThread.exec(new Runnable() {
            ...
            public void run() {
                ...
                final com.zeitheron.hammercore.lib.io.socket.engineio.client.Socket socket = Manager.this.engine;
    ...
    private void onopen() {
        ...
        final com.zeitheron.hammercore.lib.io.socket.engineio.client.Socket socket = this.engine;
    ...
    private static class Engine extends com.zeitheron.hammercore.lib.io.socket.engineio.client.Socket {
    ...
    public static class Options extends com.zeitheron.hammercore.lib.io.socket.engineio.client.Socket.Options {
