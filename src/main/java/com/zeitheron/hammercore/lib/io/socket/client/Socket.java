...
public class Socket extends Emitter
{
	...
	/**
	 * Emits an event. When you pass {@link Ack} at the last argument, then the
	 * acknowledge is done.
	 *
	 * @param event
	 *            an event name.
	 ...
	 *            data to send.
	 * @param ack
	 *            the acknowledgement to be called
	 * @return a reference to this object.
	 */
	...
	/**
	 * A property on the socket instance that is equal to the underlying
	 * engine.io socket id.
	 *
	 * The value is present once the socket has connected, is removed when the
	 * socket disconnects and is updated if the socket reconnects.
	 *
	 * @return a socket id
	 */
	public String id()
