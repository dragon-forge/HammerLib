package com.zeitheron.hammercore.lib.io.socket.parser;
...
import com.zeitheron.hammercore.lib.io.socket.hasbinary.HasBinary;
...
final public class IOParser implements Parser
{
	...
	/* package */ static class BinaryReconstructor
	{
		...
		public Packet takeBinaryData(byte[] binData)
		{
			...
			{
				Packet packet = Binary.reconstructPacket(this.reconPack, this.buffers.toArray(new byte[this.buffers.size()][]));
