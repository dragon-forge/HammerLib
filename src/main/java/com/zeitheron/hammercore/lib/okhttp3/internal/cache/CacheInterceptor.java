...
import static com.zeitheron.hammercore.lib.okhttp3.internal.Util.discard;
...
public final class CacheInterceptor implements Interceptor
{
	 ...
	 * are read by the source consumer. This is careful to discard bytes left
	 * over when the stream is closed; otherwise we may never exhaust the source
	 * stream and therefore not complete the cached response.
	 */
	...
	/**
	 * Combines cached headers with a network headers as defined by RFC 7234,
	 * 4.3.4.
	 */
	...
	/**
	 * Returns true if {@code fieldName} is content specific and therefore
	 * should always be used from cached headers.
	 */
