...
public class ItemFEBase extends Item implements IPowerContainerItem
{
	...
	public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn)
	{
		...
		tooltip.add(I18n.format("info.hammercore:energy_stored") + ": " + CommandTimeToTicks.fancyFormat(fe));
	}
	...
	public void setFE(ItemStack stack, int fe)
	{
		...
		stack.setItemDamage((int) com.zeitheron.hammercore.utils.math.MathHelper.clip((int) (256 - (fe / (double) maxFE) * 255D), 0, getMaxDamage()));
	}
