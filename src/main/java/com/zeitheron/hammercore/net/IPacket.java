...
public interface IPacket
{
	 ...
	 *
	 * @param nbt The NBT tag that was read from network.
	 */
	 ...
	 *
	 * @param nbt The NBT tag that will be written to network.
	 */
	 ...
	 *
	 * @param net A context of this packet. Mostly useless in this case.
	 ...
	 *
	 * @param net A context of this packet. Contains sender as an
	 *            {@link EntityPlayerMP}
	 * @return Reply packet, or null, if none.
	 */
	 ...
	 * @param nev The supplier of new instances for this packet.
	 */
