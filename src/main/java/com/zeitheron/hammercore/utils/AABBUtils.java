...
{
	public static Iterable<BlockPos> intersecting(AxisAlignedBB aabb)
	{
	...
	public static Iterable<BlockPos.MutableBlockPos> intersectingMutable(AxisAlignedBB aabb)
	{
	...
	public static Vec3d[] getAllEdgePoints(AxisAlignedBB aabb)
	{
		return new Vec3d[] {
