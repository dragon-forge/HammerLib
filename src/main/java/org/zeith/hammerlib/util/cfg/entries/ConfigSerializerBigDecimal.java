		...
		extends ConfigEntrySerializer<ConfigEntryBigDecimal>
{
	...
	@Override
	public void write(ConfigFile config, BufferedWriter writer, ConfigEntryBigDecimal entry, int indents) throws IOException
	{
	...
	@Override
	public ConfigEntryBigDecimal read(ConfigFile config, ReaderHelper reader, int indents) throws IOException
	{
