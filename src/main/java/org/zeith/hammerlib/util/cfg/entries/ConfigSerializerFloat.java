...
public class ConfigSerializerFloat
		extends ConfigEntrySerializer<ConfigEntryFloat>
{
	...
	@Override
	public void write(ConfigFile config, BufferedWriter writer, ConfigEntryFloat entry, int indents) throws IOException
	{
	...
	@Override
	public ConfigEntryFloat read(ConfigFile config, ReaderHelper reader, int indents) throws IOException
	{
