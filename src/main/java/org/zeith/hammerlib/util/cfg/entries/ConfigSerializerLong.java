		...
		extends ConfigEntrySerializer<ConfigEntryLong>
{
	...
	@Override
	public void write(ConfigFile config, BufferedWriter writer, ConfigEntryLong entry, int indents) throws IOException
	{
	...
	@Override
	public ConfigEntryLong read(ConfigFile config, ReaderHelper reader, int indents) throws IOException
	{
