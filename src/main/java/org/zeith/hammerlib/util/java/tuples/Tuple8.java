		...
		implements ITuple
{
	...
	public Mutable8<A, B, C, D, E, F, G, H> mutable()
	{
		return new Mutable8<>(a, b, c, d, e, f, g, h);
	}
			...
			extends Tuple8<A, B, C, D, E, F, G, H>
	{
		...
		public @Override Mutable8<A, B, C, D, E, F, G, H> mutable()
		{
			return this;
		}
		
		public @Override Mutable8<A, B, C, D, E, F, G, H> copy()
		{
			return new Mutable8<>(a, b, c, d, e, f, g, h);
		}
