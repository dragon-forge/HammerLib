		...
		implements ITuple
{
	...
	public Mutable11<A, B, C, D, E, F, G, H, I, J, K> mutable()
	{
		return new Mutable11<>(a, b, c, d, e, f, g, h, i, j, k);
	}
			...
			extends Tuple11<A, B, C, D, E, F, G, H, I, J, K>
	{
		...
		public @Override Mutable11<A, B, C, D, E, F, G, H, I, J, K> mutable()
		{
			return this;
		}
		
		public @Override Mutable11<A, B, C, D, E, F, G, H, I, J, K> copy()
		{
			return new Mutable11<>(a, b, c, d, e, f, g, h, i, j, k);
		}
