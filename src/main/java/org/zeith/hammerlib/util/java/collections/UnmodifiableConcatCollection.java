		...
		implements Collection<E>, Serializable
{
	...
	{
		return cs.stream().flatMap(Collection::stream).collect(Collectors.toList()).toArray(a);
	}
	...
	{
		return cs.stream().flatMap(Collection::stream).collect(Collectors.toSet()).containsAll(coll);
	}
