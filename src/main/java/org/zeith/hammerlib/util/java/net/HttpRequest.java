package org.zeith.hammerlib.util.java.net;
		...
		implements AutoCloseable
{
	...
	{
		return httpProxy != null ? httpProxy : new Proxy(HTTP, new InetSocketAddress(httpProxyHost, httpProxyPort));
	}
	...
	private HttpURLConnection createConnection()
	{
		try
		{
			...
			if(httpProxyHost != null || httpProxy != null)
	...
	public HttpRequest useProxy(final Proxy proxy)
	{
		if(connection != null)
			throw new IllegalStateException("The connection has already been created. This method must be called before reading or writing to the request.");
