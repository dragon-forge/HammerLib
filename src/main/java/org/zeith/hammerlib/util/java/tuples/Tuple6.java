		...
		implements ITuple
{
	...
	public Mutable6<A, B, C, D, E, F> mutable()
	{
		return new Mutable6<>(a, b, c, d, e, f);
	}
			...
			extends Tuple6<A, B, C, D, E, F>
	{
		...
		public @Override Mutable6<A, B, C, D, E, F> mutable()
		{
			return this;
		}
		
		public @Override Mutable6<A, B, C, D, E, F> copy()
		{
			return new Mutable6<>(a, b, c, d, e, f);
		}
