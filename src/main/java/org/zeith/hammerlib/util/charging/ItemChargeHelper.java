...
//		handle(FluidCharge.class, new FluidChargeHandler());
	...
	public static <T extends AbstractCharge> T chargeInventory(IInventory inv, T charge, IChargeHandler.ChargeAction simulate)
	{
	 ...
	 */
	public static <T extends AbstractCharge> T chargePlayer(PlayerEntity player, T charge, IChargeHandler.ChargeAction simulate)
	{
		IChargeHandler<T> h = getHandler(charge);
		if(h == null)
			return charge;
	...
	public static <T extends AbstractCharge> T chargeInventory(IInventory inv, Predicate<Integer> chargeSlot, T charge, IChargeHandler.ChargeAction simulate)
	{
		IChargeHandler<T> h = getHandler(charge);
		if(h == null)
			return charge;
