...
public final class DistExecutor
{
	 ...
	 * 		The dist to run on
	 * @param toRun
	 * 		A supplier of the callable to run (Supplier wrapper to ensure classloading only on the appropriate dist)
	 * @param <T>
	 * 		The return type from the callable
	 *
	 ...
	 *
	 * @param dist
	 * 		the dist which this will run on
	 * @param toRun
	 * 		the SafeCallable to run and return the result from
	 * @param <T>
	 * 		The type of the SafeCallable
	 *
	 ...
	 *
	 * @param clientTarget
	 * 		The supplier supplier to run when on the {@link Dist#CLIENT}
	 * @param serverTarget
	 * 		The supplier supplier to run when on the {@link Dist#DEDICATED_SERVER}
	 * @param <T>
	 * 		The common type to return
	 *
	...
	public interface SafeCallable<T>
			extends SafeReferent, Callable<T>, Serializable {}
	...
	public interface SafeSupplier<T>
			extends SafeReferent, Supplier<T>, Serializable {}
	
	/**
	 * SafeRunnable version of {@link SafeReferent}
	 */
	public interface SafeRunnable
			extends SafeReferent, Runnable, Serializable {}
