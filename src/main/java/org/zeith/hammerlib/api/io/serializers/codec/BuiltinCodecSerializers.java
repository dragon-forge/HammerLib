...
public interface BuiltinCodecSerializers
{
	...
	@CodecSerializer
	ICodecSerializer<FluidIngredient> FLUID_INGREDIENT_CODEC = ICodecSerializer.of(FluidIngredient.class, FluidIngredient.CODEC, Cast.constant(FluidIngredient.EMPTY));
