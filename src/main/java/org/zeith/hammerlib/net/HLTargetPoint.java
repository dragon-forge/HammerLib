		...
		extends Vec3
{
	...
	public HLTargetPoint(final Vector3d pos, final double range, final ResourceKey<Level> dim)
	{
	...
	public HLTargetPoint(final Vector3d pos, final double range, final Level world)
	{
